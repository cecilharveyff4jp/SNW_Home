...
import type { HeritageQuizState } from '../../types/animations';

interface HeritageQuizUIProps {
  quiz: HeritageQuizState;
...
export default function HeritageQuizUI({
  quiz,
  consecutiveCorrect,
  onClose,
  onChoiceClick,
    ...
    >
      <div
        style={{
          ...
          maxWidth: "700px",
          width: "100%",
          boxShadow: "0 20px 60px rgba(0,0,0,0.5), 0 0 40px rgba(100,181,246,0.3)",
      ...
      >
        {quiz.state === 'showing' && (
          <div style={{ textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "24px", color: "#64b5f6", marginBottom: "10px" }}>
              世界遺産クイズ
            </h2>
        ...
        {quiz.state === 'answering' && (
          <div>
            ...
            <div style={{ textAlign: "center", marginBottom: "30px" }}>
              ...
              <h3 style={{ fontSize: "22px", color: "#64b5f6", marginBottom: "20px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
              {quiz.choices.map((choice, index) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "linear-gradient(135deg, rgba(100,181,246,0.3) 0%, rgba(100,181,246,0.2) 100%)";
                    e.currentTarget.style.transform = "translateY(-2px)";
                    e.currentTarget.style.boxShadow = "0 8px 20px rgba(100,181,246,0.3)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = "linear-gradient(135deg, rgba(100,181,246,0.1) 0%, rgba(100,181,246,0.05) 100%)";
        ...
        {quiz.state === 'correct' && (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "24px", color: "#64b5f6", marginBottom: "10px", fontWeight: "bold" }}>
              {quiz.question.correct}
            </p>
            {quiz.question.country && (
              <p style={{ fontSize: "18px", color: "#aaa", marginBottom: "10px" }}>
                国: {quiz.question.country}
              </p>
            )}
            {quiz.question.year && (
              <p style={{ fontSize: "18px", color: "#aaa", marginBottom: "10px" }}>
                登録: {quiz.question.year}年
              </p>
            )}
            <p style={{ fontSize: "20px", color: "#64b5f6", marginBottom: "20px", fontWeight: "bold" }}>
              +{quiz.reward} コイン獲得！
            </p>
            <div style={{
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 5px 15px rgba(100,181,246,0.5)";
              }}
              onMouseLeave={(e) => {
        ...
        {quiz.state === 'wrong' && (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "28px", color: "#64b5f6", marginBottom: "10px", fontWeight: "bold" }}>
              {quiz.question.correct}
            </p>
            {quiz.question.country && (
              <p style={{ fontSize: "18px", color: "#aaa", marginBottom: "10px" }}>
